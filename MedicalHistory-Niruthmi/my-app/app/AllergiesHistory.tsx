...
import AddAllergyHistoryPage from './AddAllergyHistoryPage'; // Correct import

// Define the type for each entry in allergy history
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.historyContainer}>
        {allergyHistory.length === 0 ? (
          <Text>No allergy history available.</Text> // Display message if no records exist
        ) : (
