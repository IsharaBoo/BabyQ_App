...
//   onSubmit: (data: { weight: string; height: string;age:String; date: string }) => void;
// };
...
//     onSubmit({ weight, height, age, date });
//   };
...
//         onSubmit(newGrowthData); // Update the local state in the parent component
//       } else {
