...
export default function HomePage() {
  ...
  const ads = [
    { id: '1', image: require('../assets/images/ad5.png'), title: 'Health Insurance Plans' },
    { id: '2', image: require('../assets/images/ad2.png'), title: 'Annual Checkup Discount' },
    { id: '3', image: require('../assets/images/add1.png'), title: 'Mental Health Services' },
    { id: '4', image: require('../assets/images/ad3.png'), title: 'New Clinic Opening' },
    { id: '5', image: require('../assets/images/ad1.png'), title: 'Family Healthcare Packages' },
  ];
